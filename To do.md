...
- Edit discussion of vectors at beginning of chapter to discuss the following... There is circularity between intuitive notions of point and vector. We can resolve this circularity on a formal level by defining both "point" and "vector" in more primitive terms. Though, there is a circularity between the intuitive ideas of "point" and "vector" that will always persist. 
